...
public class Notificion implements java.io.Serializable {
	...
	private java.sql.NClob notifition_content;				// 게시글 내용
	private java.sql.Timestamp created_at;					// 게시글 작성시간
	private java.sql.Timestamp modified_at;					// 게시글 수정시간
	...
	public java.sql.NClob getNotifition_content() {
	...
	public void setNotifition_content(java.sql.NClob notifition_content) {
		this.notifition_content = notifition_content;
	}
