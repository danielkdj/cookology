...
<form action="" method="post" onsubmit="return validate();">
	...
	<fieldset>
		<label><input type="checkbox" value="allergy1">난류</label>
		<label><input type="checkbox" value="allergy2">우유, 유제품</label>
		<label><input type="checkbox" value="allergy3">땅콩</label>
		<label><input type="checkbox" value="allergy4">견과류</label><br><br>
		<label><input type="checkbox" value="allergy5">밀</label>
		<label><input type="checkbox" value="allergy6">참깨</label>
		<label><input type="checkbox" value="allergy6">콩(대두)</label>
		<label><input type="checkbox" value="allergy6">과일 및 채소</label><br><br>
		<label><input type="checkbox" value="allergy6">해산물 및 조개류</label>
		<label><input type="checkbox" value="allergy6">육류</label>
	</fieldset><br><br><br>
